...
namespace LRC
{
    public class EncodeHelper
    {
        ...
        {
            string qqHexStr = ToHexString(singer + title, Encoding.UTF8);
            ...
            int t5 = (int)Convert(t2 ^ t3);
            t5 = (int)Convert(t5 + (t1 | lrcId));
            t5 = (int)Convert(t5 * (t1 | t3));
            t5 = (int)Convert(t5 * (t2 ^ lrcId));
